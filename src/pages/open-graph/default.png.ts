...
"></div>
        ...
        <div
          ...
          "
        >
          <div style="display: flex; font-size: 64px; font-weight: 700; color: ${COLORS.primary}; line-height: 1.2;">
            Async
          </div>
          <div style="display: flex; font-size: 32px; font-weight: 400; color: ${COLORS.textMuted}; margin-top: 24px;">
