...
Put differently: the agent can’t directly read files or write code, but it can _ask_ you to do those things in a structured way. You run whatever it asked for, send back the result, and the agent uses that to decide what to do next.
...
And that’s it. We have our own coding agent in 331 lines of code!
